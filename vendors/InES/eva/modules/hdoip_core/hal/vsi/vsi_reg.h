...
#define VSI_OFF_DST_MAC_1               (0x0018)
#define VSI_OFF_DST_MAC_0               (0x0019)
#define VSI_OFF_DST_MAC_5               (0x001c)
#define VSI_OFF_DST_MAC_4               (0x001d)
#define VSI_OFF_DST_MAC_3               (0x001e)
#define VSI_OFF_DST_MAC_2               (0x001f)
#define VSI_OFF_SRC_MAC_3               (0x0020)
#define VSI_OFF_SRC_MAC_2               (0x0021)
#define VSI_OFF_SRC_MAC_1               (0x0022)
#define VSI_OFF_SRC_MAC_0               (0x0023)
#define VSI_OFF_SRC_MAC_5               (0x0024)
#define VSI_OFF_SRC_MAC_4               (0x0025)
