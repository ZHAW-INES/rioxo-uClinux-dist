...
#define ASI_OFF_DST_MAC_FIRST2      (ASI_BASE_PACKETIZE + 0x0004)
#define ASI_OFF_DST_MAC_LAST4       (ASI_BASE_PACKETIZE + 0x0008)
#define ASI_OFF_SRC_MAC_FIRST4      (ASI_BASE_PACKETIZE + 0x000C)
#define ASI_OFF_SRC_MAC_LAST2       (ASI_BASE_PACKETIZE + 0x0010)
