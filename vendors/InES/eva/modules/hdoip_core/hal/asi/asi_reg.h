...
#define ASI_REG_DST_MAC_0           (0x0004)
#define ASI_REG_DST_MAC_1           (0x0005)
#define ASI_REG_DST_MAC_2           (0x0008)
#define ASI_REG_DST_MAC_3           (0x0009)
#define ASI_REG_DST_MAC_4           (0x000a)
#define ASI_REG_DST_MAC_5           (0x000b)
#define ASI_REG_SRC_MAC_0           (0x000c)
#define ASI_REG_SRC_MAC_1           (0x000d)
#define ASI_REG_SRC_MAC_2           (0x000e)
#define ASI_REG_SRC_MAC_3           (0x000f)
#define ASI_REG_SRC_MAC_4           (0x0010)
#define ASI_REG_SRC_MAC_5           (0x0011)
#define ASI_REG_TTL_TOS             (0x0014)
#define ASI_REG_SRC_IP              (0x0018)
#define ASI_REG_DST_IP              (0x001C)
#define ASI_REG_SRC_PORT            (0x0020)
#define ASI_REG_DST_PORT            (0x0024)
