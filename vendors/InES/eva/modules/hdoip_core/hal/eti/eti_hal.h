...
#define eti_set_aud_desc(p, d)              rbf_set_dsc_wc((p), ETI_AUD_START_REG, (d))
#define eti_set_aud_start_desc(p, v)		RBF_SET_REG((p), ETI_AUD_START_REG, (v))
#define eti_set_aud_stop_desc(p, v)		    RBF_SET_REG((p), ETI_AUD_STOP_REG, (v))
#define eti_set_aud_write_desc(p, v)		RBF_SET_REG((p), ETI_AUD_WRITE_REG, (v))
#define eti_set_vid_desc(p, d)              rbf_set_dsc_wc((p), ETI_VID_START_REG, (d))
#define eti_set_vid_start_desc(p, v)		RBF_SET_REG((p), ETI_VID_START_REG, (v))
#define eti_set_vid_stop_desc(p, v)		    RBF_SET_REG((p), ETI_VID_STOP_REG, (v))
#define eti_set_vid_write_desc(p, v)		RBF_SET_REG((p), ETI_VID_WRITE_REG, (v))
