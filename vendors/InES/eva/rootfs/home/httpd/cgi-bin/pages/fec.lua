...
function show(t)
    ...
    if(t.sent == nil) then
        ...
        temp_reg = t.fec_video_en .. t.fec_video_l .. t.fec_video_d .. t.fec_video_interleave .. t.fec_video_column_only .. t.fec_audio_en .. t.fec_audio_l .. t.fec_audio_d .. t.fec_audio_interleave .. t.fec_audio_column_only
    ...
    if(t.mode_vtb) then   
        hdoip.html.Title(label.p_fec_video)                                                                                                                                 hdoip.html.TableInsElement(2);
        hdoip.html.Title(label.p_fec_audio)                                                                                                                                 hdoip.html.TableInsElement(2);
