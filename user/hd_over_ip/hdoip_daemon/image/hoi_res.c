 ...
 *  +--+-----+-----+----------+-----+----+-----+------+-----+----+-----+------+------+
 */
#define FORMAT_COUNT 13
const t_video_timing VFORMAT[] = {
    { 0,  640,  480,  25000000,   16,  96,   48,     H,   11,   2,   32,   H,   P,  0,  0,  0,  0,  0},
    { 1,  800,  600,  40000000,   40, 128,   88,     H,    1,   4,   23,   H,   P,  0,  0,  0,  0,  0},
    { 2, 1024,  768,  65000000,   24, 136,  160,     H,    3,   6,   29,   H,   P,  0,  0,  0,  0,  0},
    { 3, 1152,  864,  81624000,   64, 120,  184,     H,    1,   3,   27,   H,   P,  0,  0,  0,  0,  0},
    { 4, 1280,  960, 102103680,   80, 136,  216,     H,    1,   3,   30,   H,   P,  0,  0,  0,  0,  0},
    { 5, 1280, 1024, 108000000,   48, 112,  248,     H,    1,   3,   38,   H,   P,  0,  0,  0,  0,  0},
    { 6, 1600, 1200, 162000000,   64, 192,  304,     H,    1,   3,   46,   H,   P,  0,  0,  0,  0,  0},
    { 7,  720,  576,  27000000,   13,  64,   67,     L,    5,   5,   39,   L,   P,  0,  0,  0,  0,  0},
    { 8,  720,  480,  27000000,   16,  62,   60,     L,    9,   6,   30,   L,   P,  0,  0,  0,  0,  0},
    { 9, 1280,  720,  74250000,  110,  40,  220,     H,    5,   5,   20,   H,   P,  0,  0,  0,  0,  0},
    {10, 1920, 1080, 148500000,   88,  44,  148,     H,    4,   5,   36,   H,   P,  0,  0,  0,  0,  0},         /*60Hz*/
    {11, 1920, 1080, 148500000,  528,  44,  148,     H,    4,   5,   36,   H,   P,  0,  0,  0,  0,  0},         /*50Hz*/
    {12, 1920, 1080,  74250000,  638,  44,  148,     H,    4,   5,   36,   H,   P,  0,  0,  0,  0,  0}          /*24Hz*/

};

static int intabs(int a, int b)
{
    int c = a - b;
    if (c<0) c=-c;
    return c;
