...
typedef union {
    t_rtsp_req_option   option;
    t_rtsp_req_setup    setup;
    t_rtsp_req_play     play;
    t_rtsp_req_teardown teardown;
} u_rtsp_request;
...
typedef union {
    t_rtsp_rsp_option   option;
    t_rtsp_rsp_setup    setup;
    t_rtsp_rsp_play     play;
    t_rtsp_rsp_teardown teardown;
} u_rtsp_response;
